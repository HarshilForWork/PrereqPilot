...
def _build_transcripts(
	...
	eligibility_id = "prereq_03"
	plan_id = "program_01"
	abstention_id = "trick_01"
...
def _parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Run evaluation against a running PrereqPilot API.")
	parser.add_argument(
		"--base-url",
...
def main() -> None:
	...
	eval_set_path = str(base / "eval_set.json")
